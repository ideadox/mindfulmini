      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: [
              HexColor('#6E40F9').withValues(alpha: 0.3),
              HexColor('#A569FB').withValues(alpha: 0.2),
              HexColor('#CE89FF').withValues(alpha: 0.1),
            ],
          ),
        ),
        child: Container(
          ...
          decoration: BoxDecoration(
            color:
                radioValue == groupValue ? HexColor('#E8F0FE') : Colors.white,
