    ...
    return ChangeNotifierProvider(
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: Consumer<ShidiChatProvider>(builder: (context, provider, _) {
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: AnimatedSwitcher(
                        ...
                        child: !provider.isEmptyTextField
                            ? IconButton(
                                key: UniqueKey(),
                                onPressed: () {},
                                icon: Container(
                            ...
                            : IconButton(
                                ...
                                icon: SvgPicture.asset(Assets.icons.shidiVoice),
                              ),
                      ),
